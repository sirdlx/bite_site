...
List<CartItem> demoCartItems = List.generate(
  5,
  (indx) => CartItem(
    title: indx.toString(),
    basePrice: (indx * 1.2).toInt(),
  ),
);

Map<String, dynamic> demoMenu = {
  ...
  "restaurant-info": {
    ...
    "user-favourite": "",
    "name": "Nandos Banani",
    "address": "2910 E Speedway Blvd, Tucson, AZ, 85716",
    "rating": "5.00",
    "minimum-order-price": 500,
    "logo":
        "https://s3-ap-southeast-2.amazonaws.com/aisdevtest/img/2b41b7bbf6da38212e1163c428d44f3a58b1487817bf3.jpg",
    "open-status": "1",
    "default-ad": "",
    "review-enabled": "1",
    "social-share": "0",
    ...
    "payment-methods": [
      {"id": "1", "type": "Card/Debit Card"},
      {"id": "3", "type": "bKash"},
      {"id": "4", "type": "Cash On Delivery"}
    ],
    "delivery-types": "0",
    "tags": [],
    "deliverable-area": [
      ...
      {"id": "3", "name": "Gulshan 2"},
      {"id": "4", "name": "Baridhara"},
      {"id": "6", "name": "Mohakhali DOHS "},
      {"id": "7", "name": "Banani DOHS"},
      {"id": "8", "name": "Baridhara DOHS"},
      {"id": "18", "name": "Bashundhara"},
      {"id": "19", "name": "Mirpur DOHS"},
      {"id": "164", "name": "300 feet road bashundhara"}
    ],
    "ratings": [
      {"rating": ""}
    ],
