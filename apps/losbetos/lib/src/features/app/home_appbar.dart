...
import 'package:losbetosapp/src/features/settings/settings_view.dart';
...
PreferredSizeWidget homeAppBarOLD(BuildContext context) => AppBar(
      ...
      actions: [
        IconButton(
          onPressed: () {
            appController.globalNavKey.currentState!.pushNamed('/login');
          },
...
AppBar homeAppBar(BuildContext context) {
  return AppBar(
    ...
    leading: IconButton(
      ...
      onPressed: () {
        appController.homeScaffoldKey.currentState!.openDrawer();
      },
    ),
    title: Row(
      children: [
